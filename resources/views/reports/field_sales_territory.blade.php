...
<head>
    <meta charset="UTF-8">
    <title>Field Sales Territory Performance Report</title>
    <style>
...
<body>
    <h1>HDP(K) LTD</h1>
    <h2>Field Sales Territory Performance Report</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="7" style="text-align: center;">No data available for the selected range.</td>
                </tr>
            @endforelse
        </tbody>
    </table>
